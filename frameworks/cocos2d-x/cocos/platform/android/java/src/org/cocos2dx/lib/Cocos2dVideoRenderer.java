...
public class Cocos2dVideoRenderer  extends MediaCodecRenderer {
     ...
     */
    public Cocos2dVideoRenderer(Context context, MediaCodecSelector mediaCodecSelector) {
