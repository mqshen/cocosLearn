...
public class WebViewHelper {
    ...
    public WebViewHelper(FrameLayout layout) {
        ...
        WebViewHelper.cocos2dxActivity = (Cocos2dxActivity) Cocos2dxActivity.getContext();
        WebViewHelper.webViews = new SparseArray<Cocos2dxWebView>();
    }
    ...
    public static float getOpacityWebView(final int index) {
        if(android.os.Build.VERSION.SDK_INT >10){
            ...
            cocos2dxActivity.runOnUiThread(futureResult);
            try {
